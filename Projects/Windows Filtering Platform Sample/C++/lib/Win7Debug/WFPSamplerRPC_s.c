...
extern const MIDL_SERVER_INFO IWFPSampler_ServerInfo;
...
extern const RPC_DISPATCH_TABLE IWFPSampler_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE IWFPSampler___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x53504657,0x6D61,0x6C70,{0x65,0x72,0x5F,0x49,0x6E,0x74,0x65,0x72}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&IWFPSampler_v1_0_DispatchTable,
    1,
    (RPC_PROTSEQ_ENDPOINT *)__RpcProtseqEndpoint,
    0,
    &IWFPSampler_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE IWFPSampler_v1_0_s_ifspec = (RPC_IF_HANDLE)& IWFPSampler___RpcServerInterface;
...
static const MIDL_STUB_DESC IWFPSampler_StubDesc = 
    {
    (void *)& IWFPSampler___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION IWFPSampler_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE IWFPSampler_v1_0_DispatchTable = 
    {
    10,
    (RPC_DISPATCH_FUNCTION*)IWFPSampler_table
    };

static const SERVER_ROUTINE IWFPSampler_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)RPCInvokeScenarioAppContainer,
    (SERVER_ROUTINE)RPCInvokeScenarioBasicAction,
    (SERVER_ROUTINE)RPCInvokeScenarioBasicPacketExamination,
    (SERVER_ROUTINE)RPCInvokeScenarioBasicPacketInjection,
    (SERVER_ROUTINE)RPCInvokeScenarioBasicPacketModification,
    (SERVER_ROUTINE)RPCInvokeScenarioBasicStreamInjection,
    (SERVER_ROUTINE)RPCInvokeScenarioFastPacketInjection,
    (SERVER_ROUTINE)RPCInvokeScenarioFastStreamInjection,
    (SERVER_ROUTINE)RPCInvokeScenarioPendAuthorization,
    (SERVER_ROUTINE)RPCInvokeScenarioProxy
    };

static const MIDL_SERVER_INFO IWFPSampler_ServerInfo = 
    {
    &IWFPSampler_StubDesc,
    IWFPSampler_ServerRoutineTable,
    WFPSamplerRPC__MIDL_ProcFormatString.Format,
    IWFPSampler_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
